<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:77:"D:\phpStudy\WWW\paiming\public/../application/admin\view\manus\rejection.html";i:1509525713;s:72:"D:\phpStudy\WWW\paiming\public/../application/admin\view\layout\top.html";i:1508468134;s:75:"D:\phpStudy\WWW\paiming\public/../application/admin\view\layout\header.html";i:1508461597;s:73:"D:\phpStudy\WWW\paiming\public/../application/admin\view\layout\left.html";i:1509522948;s:75:"D:\phpStudy\WWW\paiming\public/../application/admin\view\layout\footer.html";i:1507712274;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="panel-body">
                        <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0"
                            ...
                            <tr>
                                ...
                                <td><?php switch($v['article_status']): case "-3": ?>失败<?php break; case "-2": ?>待审核<?php break; case "-1": ?>待发布<?php break; case "1": ?>正常<?php break; case "2": ?>申请退稿<?php break; case "3": ?>禁言<?php break; case "4": ?>删除<?php break; case "5": ?>已退稿<?php break; endswitch; ?>
                                </td>
                                <td><?php echo date('Y-m-d H:i:s',$v['add_time']); ?> </td>                                    
                                <td>
                                <?php if(($v['pay_status'] == 2) AND ($v['article_status'] == 2)): ?>
                                    <a href="javascript:;" manusId="<?php echo $v['id']; ?>" media_price="<?php echo $v['yunying_price']; ?>" pay_status="<?php echo $v['pay_status']; ?>"  onclick="confirms(<?php echo $v['id']; ?>)"><button class="btn btn-primary">确认退款</button></a>                              
                                 <?php endif; ?>
